        ...
        <!-- Card Start -->
          <div class="col-md-3 " style=" margin-left:25px; padding-top: 30px;">
                <div class="card" style="width: 18rem;">
                  <img class="card-img-top" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTGBxkv9s-h-pYvWuXK89w20-BKXSXZQUaYCrbBrAeTb-_Sp6FGEfMeLL7BEnpm0DDQIPA&usqp=CAU" alt="shinzo" height="350px">
                  <div class="card-body">
